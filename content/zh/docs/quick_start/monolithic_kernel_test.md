...
为了自动化支持相关的测例，基于 [rel4-cli](./rel4-cli.md)，我们也构建了[相关脚本](https://github.com/reL4team2/rel4-kernel-autobuild/tree/rel4-integrate)，在这里，根据内核的编译方式，分别提供了lib方式（即依然和很少一部分C代码链接在一起的构建方式，主要是用于调试）和bin方式（reL4作为一个独立的内核和宏内核测例相链接）
